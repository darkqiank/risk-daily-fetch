...
export const RiskEyeLogo: React.FC<IconSvgProps> = ({
  size = 36,
  height,
  ...props
}) => (
  ...
  >
    ...
    />
    <path
      d="M16 8V10M24 12L22 14M8 12L10 14M16 22V24"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth="2"
...
export const XLogo: React.FC<IconSvgProps> = ({
  size = 12,
  height,
  ...props
}) => (
...
export const MyLinkIcon = ({
  link = "/icons/default_logo.svg",
  width = 50,
  height = 50,
}) => {
  return (
    <div style={{ display: "flex", alignItems: "center" }}>
      <Image alt="link icon" height={height} src={link} width={width} />
    </div>
  );
};
